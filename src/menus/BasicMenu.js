...
const BasicMenu = () => {
    ...
    return (<div className="bg-base-100 shadow-md relative z-50">
        <div className="navbar container mx-auto px-2 sm:px-4 lg:px-8">
            <div className="navbar-start">
                ...
                <div className="flex items-center h-16 cursor-pointer" onClick={() => navigate('/')}>
                    <img
                        ...
                        alt="TOGERUN"
                        className="h-12 w-auto object-contain" /* 높이를 h-8에서 h-12로 증가 */
                    />
                </div>
            </div>
            ...
            <div className="navbar-center hidden lg:flex">
                <ul className="menu menu-horizontal px-1 space-x-2">
                    {loginState.roleNames && loginState.roleNames.includes("ROLE_ADMIN") && (<li>
                        <button
            ...
            <div className="navbar-end">
                ...
                {loginState.email ? (<div className="dropdown dropdown-end">
                    <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
                        <div className="w-8 rounded-full">
                            {loginState.img ? (<img src={loginState.img} alt="프로필"/>) : (
                    ...
                    <ul tabIndex={0}
                        ...
                        <li>
                            <button onClick={toggleLogoutModal}>로그아웃</button>
                                   ...
                                   onClick={() => navigate("/member/login")}>로그인</button>)}
            </div>
        </div>
        ...
        {/* 모바일 검색 */}
        <div
            className={`lg:hidden bg-base-100 overflow-hidden transition-all duration-300 ease-in-out ${isSearchVisible ? 'max-h-20' : 'max-h-0'}`}>
            <div className="p-2">
                <form onSubmit={handleSearch} className="flex items-center">
                    <input
                        type="text"
        ...
        {showLogoutModal && (<div className="modal modal-open">
        ...
        {logoutMutation.isSuccess && (<ResultModal
            title={'로그아웃'}
