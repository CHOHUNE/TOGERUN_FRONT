...
const BasicMenu = () => {
    ...
    return (
        <div className="bg-base-100 shadow-md relative z-50">
            <div className="navbar h-14 container mx-auto px-2 sm:px-4 lg:px-8"> {/* navbar 높이 고정 */}
                <div className="navbar-start">
                    <button onClick={toggleMobileMenu} className="btn btn-ghost lg:hidden">
                        <Bars3Icon className="h-5 w-5"/>
                    </button>
                    <div className="flex items-center cursor-pointer overflow-visible" onClick={() => navigate('/')}>
                        <img
